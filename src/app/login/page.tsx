  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="text-sm text-[var(--text-muted)] font-sans">Sign in to manage your bookings</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-xs text-[var(--text-muted)] font-sans">Remember me</span>
          </label>
