              ...
              {vehicles.map((vehicle) => (
                <div key={vehicle.id} className="bg-[var(--surface-card)] border border-[var(--line-soft)] overflow-hidden group">
                  <div className="relative h-48">
                    {vehicle.image_url ? (
                      <Image src={vehicle.image_url} alt={vehicle.translated_name} fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                    ) : (
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-lg font-serif text-[var(--text-primary)] mt-2 mb-2">{vehicle.translated_name}</h3>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="text-lg font-serif text-[var(--text-primary)]">
                              {route.translated_pickup_name} <ArrowRight size={14} className="inline mx-2 text-primary" /> {route.translated_dropoff_name}
                            </p>
