...
interface TourBookingFiltersProps {
...
export default function TourBookingFilters({ onFiltersChange }: TourBookingFiltersProps) {
  ...
  const emitFilters = useCallback(
    (overrides?: Record<string, string>) => {
      const filters: Record<string, string> = {
        status, tour_id: tourId, user_id: userId,
    ...
    [status, tourId, userId, dateFrom, dateTo, onFiltersChange]
  );
