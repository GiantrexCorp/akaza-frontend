      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-[var(--line-soft)]">
            ...
            <th className="text-left px-4 py-3 text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em] font-sans">Date / Time</th>
            <th className="text-left px-4 py-3 text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em] font-sans">Pax</th>
        ...
        <tbody>
          {bookings.map((booking) => (
            <tr
              key={booking.id}
              onClick={() => router.push(`/admin/bookings/transfers/${booking.id}`)}
