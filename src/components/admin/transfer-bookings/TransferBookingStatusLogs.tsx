            ...
            <div className="flex items-center gap-2 shrink-0">
              {log.from_status ? (
                <Badge
                  ...
                  color={SERVICE_BOOKING_STATUS_COLORS[log.from_status as TransferBookingStatus] || 'gray'}
                  size="sm"
                />
              ) : (
              ...
              <Badge
                ...
                color={SERVICE_BOOKING_STATUS_COLORS[log.to_status as TransferBookingStatus] || 'gray'}
                size="sm"
              />
            </div>
